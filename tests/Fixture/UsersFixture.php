...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'superuser' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        'r_password' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'r_password' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
